...
Humichip_RR <- Humichip %>%
  ...
  select(-gene, -Genbank.ID, -geneCategory,  
...
ggsave("results/figures/Humichip_RespRatio_Visit_subcategory2.png", height = 10, width = 15)
