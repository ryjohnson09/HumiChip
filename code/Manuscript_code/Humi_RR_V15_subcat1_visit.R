######################################################################
# Name: Humi_RR_V15_subcat1_visit.R
# Author: Ryan Johnson
...
humi_RR <- humi_grouped %>% 
  ...
  group_by(Gene_category, Subcategory1, visit_number) %>% 
...
ggsave(plot = RR_plot, filename = "results/figures/Manuscript_Figures/RR_V15_subcat1_visit.png", 
       height = 5, 
       width = 4)
