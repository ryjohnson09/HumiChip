######################################################################
# Name: Humi_RR_V1_geneCat_Kenya_Djibouti.R
# Author: Ryan Johnson
...
humi_RR <- humi_grouped %>% 
  # Group by Gene_category and country
  group_by(Gene_category, country) %>% 
...
ggsave(plot = RR_plot, filename = "results/figures/Manuscript_Figures/RR_V1_geneCat_Kenya_Djibouti.png", height = 8, width = 8)
