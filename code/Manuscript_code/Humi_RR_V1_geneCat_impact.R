######################################################################
# Name: Humi_RR_V1_geneCat_impact.R
# Author: Ryan Johnson
...
humi_RR <- humi_grouped %>% 
  # Group by Gene_category and Impact
  group_by(Gene_category, Impact) %>% 
...
ggsave(plot = RR_plot, filename = "results/figures/Manuscript_Figures/RR_V1_geneCat_impact.png", height = 8, width = 8)
