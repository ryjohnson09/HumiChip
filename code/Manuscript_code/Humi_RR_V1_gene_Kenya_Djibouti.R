######################################################################
# Name: Humi_RR_V1_gene_Kenya_Djibouti.R
# Author: Ryan Johnson
...
ggsave(plot = RR_plot, filename = "results/figures/Manuscript_Figures/RR_V1_gene_Kenya_Djibouti.png", height = 10, width = 8)
