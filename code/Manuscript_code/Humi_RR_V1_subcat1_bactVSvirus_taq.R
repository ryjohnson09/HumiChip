######################################################################
# Name: Humi_RR_V1_subcat1_taq_bactVSvirus.R
# Author: Ryan Johnson
...
ggsave(plot = RR_plot, filename = "results/figures/Manuscript_Figures/RR_V1_subcat1_bactVSvirus_taq.png",
       height = 8,
       width = 9)
