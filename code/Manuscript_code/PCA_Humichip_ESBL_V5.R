...
humi_PCA_plot <- humi_PCA_base +
  ...
  stat_ellipse(aes(x = PC1, y = PC2, color = ESBL_V5), level = 0.75, size = 1.5, linetype = "dashed")

humi_PCA_plot

ggsave(plot = humi_PCA_plot, filename = "results/figures/Manuscript_Figures/Humi_subcat1_ESBL_V5_PCA.png", 
       height = 7, 
       width = 8)
