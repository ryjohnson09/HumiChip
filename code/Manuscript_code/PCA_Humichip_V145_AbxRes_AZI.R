####################################################################
# Name: PCA_Humichip_V145_AbxRes_AZI.R
# Author: Ryan Johnson
# Date Created: 4 Sep 2019
# Purpose: Perform PCA on Humichip Data, visit 1-4-5 samples, color
#   by visit. Only consider patients in AZI group. Only use Abx
#   Res probes
####################################################################
...
ggsave(plot = humi_PCA_plot, filename = "results/figures/Manuscript_Figures/Humi_V145_AbxRes_AZI_PCA.png", 
       height = 7, 
       width = 8)
