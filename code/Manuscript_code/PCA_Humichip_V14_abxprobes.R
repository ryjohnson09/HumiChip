####################################################################
# Name: PCA_Humichip_V14_abxprobes.R
# Author: Ryan Johnson
# Date Created: 3 Sep 2019
# Purpose: Perform PCA on Humichip Data, visit 1-4 samples, only
...
humi_PCA_plot <- humi_PCA_base +
  ...
  scale_color_discrete(breaks=c(1, 4),
                       labels=c("Day 0", "Day 7"))

humi_PCA_plot

ggsave(plot = humi_PCA_plot, filename = "results/figures/Manuscript_Figures/Humi_V14_abxprobes_PCA.png", 
       height = 7, 
       width = 8)
