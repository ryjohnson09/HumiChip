##################################################################
# Name: PCA_Humichip_V1_LLS.R [Figure 1]
# Author: Ryan Johnson
...
humi_PCA_plot <- humi_PCA_base +
  ...
  stat_ellipse(aes(x = PC1, y = PC2, color = LLS_severity), level = 0.75, size = 1.5, linetype = "dashed")

humi_PCA_plot

ggsave(plot = humi_PCA_plot, filename = "results/figures/Manuscript_Figures/Humi_V1_LLS_PCA.png", height = 8, width = 9)
